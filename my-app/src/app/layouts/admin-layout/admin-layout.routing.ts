...
export const AdminLayoutRoutes: Routes = [
    ...
    { path: 'etudiant-valide',     component: EtudiantValideComponent },
    { path: 'etudiant-non-valide',     component: EtudiantNonValideComponent },
    { path: 'etudiant-en-cours',     component: EtudiantEnCoursComponent },
];
